...
public class EnemyShotgunRifleAreaScript : MonoBehaviour
{
    private bool playerWasOnArea = false;
    private EnemyRifleMove enemyMove;
   ...
   // [SerializeField]
    ...
    void Start()
    {
        ...
        enemyMove = this.gameObject.transform.parent.GetComponent<EnemyRifleMove>();
